...
def main(
    ...
    if not without_labels:
        ...
        plt.savefig(f"{output_dir}/roc_curve_nn_{num_neighbors}.png", dpi=150, bbox_inches='tight')
        plt.close()
        ...
        plt.savefig(f"{output_dir}/pr_curve_nn_{num_neighbors}.png", dpi=150, bbox_inches='tight')
        plt.close()
